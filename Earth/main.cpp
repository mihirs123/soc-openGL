...
glm::vec3 lightPos(2.0f, 0.0f , 50.0f);
...
float atmosphereRadius = radius * 1.05;
  ...
  {
    "space/starfield_rt.tga",
    "space/starfield_lf.tga",
    "space/starfield_up.tga",
    "space/starfield_dn.tga",
    "space/starfield_ft.tga",
    "space/starfield_bk.tga"
  };
  ...
  while (glfwWindowShouldClose(window) == 0)
    {
     ...
     g_fSunRotation = fmod(g_fSunRotation, 360.0f);  
      ...
      ourShader.setVec3("lightPos", glm::vec3(sunPos));
        ...
        // light properties
        ourShader.setVec3("light.ambient", 0.85f, 0.85f, 0.85f);
